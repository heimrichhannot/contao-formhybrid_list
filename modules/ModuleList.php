...
class ModuleList extends \Module
{
	...
	protected function compile()
	{
		...
		if ((!$this->hideFilter || $this->formHybridLinkedFilter) && $this->objFilterForm->isSubmitted() && !$this->objFilterForm->doNotSubmit()) {
	...
	protected function getItems($objFilterSubmission = null)
	{
		...
		// set filter values
		if ((!$this->hideFilter || $this->formHybridLinkedFilter) && $objFilterSubmission) {
