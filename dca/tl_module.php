...
$arrFields = [
    ...
    'customFilterFields' => [
        ...
        'exclude'          => true,
        'eval'             => [
            'multiple' => true, 'includeBlankOption' => true,
    ...
    'dummyImage' => [
        ...
        'inputType' => 'fileTree',
        'eval'      => [
            'tl_class'  => 'w50', 'filesOnly' => true, 'extensions' => Config::get('validImageTypes'),
    ...
    'aliasField' => [
        ...
        'exclude'                 => true,
        'eval'					  => [
            'tl_class'       => 'w50 clr', 'includeBlankOption' => true,
...
{
	$arrFields = array_merge($arrFields, [
