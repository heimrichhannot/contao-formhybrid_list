...
$arrLang['useModal']  							= ['Instanzen in Modalfenstern ausgeben', 'Wählen Sie diese Option, wenn die Instanzen in Modalfenstern ausgegeben werden sollen.'];
$arrLang['modalWrapperTpl']  					= ['Modal-Template (Wrapper)', 'Wählen Sie hier das Template für den Modal-Wrapper aus.'];
$arrLang['modalTpl']  							= ['Modal-Template', 'Wählen Sie hier das Template für das Modalfenster aus.'];
$arrLang['modalClass']  						= ['Modal-CSS-Klasse', 'Geben Sie hier bei Bedarf CSS-Klassen für das Modalfenster ein (bspw. "fade").'];
$arrLang['modalInnerClass']  					= ['Innere Modal-CSS-Klasse', 'Geben Sie hier bei Bedarf CSS-Klassen für das innere DIV im Modalfenster ein (bspw. "modal-lg").'];
