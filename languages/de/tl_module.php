...
$arrLang['addAjaxPagination']					= array('Ajax-Paginierung hinzufügen', 'Wählen Sie diese Option, wenn eine Ajax-Paginierung genutzt werden soll. Dafür muss ein Wert > 0 in "Elemente pro Seite" gesetzt sein. Die Seitenzahlen werden durch einen einzelnen "Weiter"-Button ersetzt.');
$arrLang['addInfiniteScroll']					= array('Infinite Scroll hinzufügen', 'Wählen Sie diese Option, um die Ajax-Paginierung im UI-Muster "Infinite Scroll" umzusetzen.');
